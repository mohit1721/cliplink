...
const AboutPage = () => {
  return (
    <div className="bg-[#183B4E] lg:px-14 sm:px-8 px-5 min-h-[calc(100vh-64px)] pt-2">
      <div className="bg-[#183B4E] w-full sm:py-10 py-8  ">
        <h1 className="sm:text-4xl text-[#DDA853] text-3xl font-bold italic  mb-3">
          About ClipLink
        </h1>
        <p className="text-[#F3F3E0] text-sm  mb-8 xl:w-[60%] lg:w-[70%] sm:w-[80%] w-full ">
        ...
        <div className="space-y-5 xl:w-[60%] lg:w-[70%] sm:w-[80%] w-full ">
          <div className="flex items-start">
            ...
            <div>
              <h2 className="sm:text-2xl font-bold text-[#DDA853]">
